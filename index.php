            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-6 col-sm-6">
                     <ul class="lan">
                        <li><i class="fa fa-globe" aria-hidden="true"></i><?php echo "Language :";?>  <img src="images/fleg.png" alt="#" /></li>
                     </ul>
                     <form action="#">
                        <div class="select-box">
                           <label for="select-box1" class="label select-box1"><span class="label-desc"><?php echo "English";?></span> </label>
            ...
            <div class="container">
               <div class="row d_flex">
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon">
                        <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i><?php echo "Call Us : +01 1234567890";?> </a> </li>
                     </ul>
                  </div>
                  ...
                  <div class="col-md-4 col-sm-4 d_none">
                     <ul class="conta_icon ">
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo "demo@gmail.com";?> </a> </li>
                     </ul>
                  </div>
               </div>
            </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="about.html"><?php echo "about";?></a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="service.html"><?php echo "services";?></a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="team.html"><?php echo "team";?> </a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="client.html"><?php echo "Clients";?></a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="contact.html"><?php echo "contact us";?>  </a>
                              </li>
                           </ul>
                        </div>
                     </nav>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-7 col-lg-7">
               <div class="text-bg">
                  <h1><?php echo "Trusted and";?> <br><?php echo "Professional Advisers";?></h1>
                  <span><?php echo "for your Business";?></span>
                  <p><?php echo "Showcase your Profile to the world using online CV builder and Get Hired Faster";?></p>
                  <a href="#"><?php echo "About us";?></a>
               </div>
            </div>
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-md-12 col-lg-7">
               <div class="about_box">
                  <div class="titlepage">
                     <h2><strong class="yellow"><?php echo "About US";?></strong><br><?php echo "WE CAN HELP YOUR business GROW";?> </h2>
                  </div>
                  <h3><?php echo "EVERYTHING YOU NEED IN ONE SOLUTION";?></h3>
                  <span><?php echo "HELP YOUR NEXT CAREER MOVE MORE SMOOTHER AND";?> <br><?php echo "MORE EFFICIENT";?> </span>
                  <p><?php echo "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of usingt";?></p>
                  <span class="try"><?php echo "TRY ONLINE CV BUILDER FOR Free";?></span>
                  <a class="read_morea" href="#"><?php echo "Get Started";?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-md-12 ">
               <div class="titlepage">
                  ...
                  <p><?php echo "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distrib";?></p>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-5 col-md-6 col-sm-6">
                  ...
                  <ul class="location_icon">
                     ...
                     <li><a href="#"><i class="fa fa-volume-control-phone" aria-hidden="true"></i></a><?php echo "+01 1234567890";?><br><?php echo "+01 1234567889";?></li>
                  </ul>
               ...
               <div class="col-lg-2 col-md-6 col-sm-6">
                  ...
                  <ul class="link_icon">
                     ...
                     <li> <a href="service.html"> </i><?php echo "Services";?></a></li>
                     <li> <a href="team.html"></i><?php echo "Team";?></a></li>
                     <li> <a href="client.html"></i><?php echo "Clients";?></a></li>
                     <li> <a href="contact.html"></i><?php echo "Contact us";?></a></li>
                  </ul>
               </div>
               <div class="col-lg-2 col-md-6 col-sm-6">
